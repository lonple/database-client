...
/**
 * 使用 manage-kek 对连接密码等敏感字段做 AES-GCM 加解密。
 */
@Component
public class ManageKekCryptoService {
    ...
    public ManageKekCryptoService(SecretFileStore secretFileStore) {
        String kekMaterial = secretFileStore.readOrCreate(SecretFileStore.FILE_MANAGE_KEK, 32);
    ...
    public String encrypt(String plain) {
        try {
            ...
            throw BizException.badRequest("manage-kek 加密失败");
        }
    }
    ...
    public String decrypt(String cipherText) {
        try {
            ...
            throw BizException.badRequest("manage-kek 解密失败");
        }
    }
    ...
    private static SecretKey deriveAesKey(String material) {
        try {
            ...
            throw new IllegalStateException("派生 manage-kek 失败", e);
        }
    }
}
